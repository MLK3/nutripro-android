...
public class CameraActivity extends BaseActivity implements
        ...
        switch (requestCode) {
            ...
            case REQUEST_IMAGE_SELECTOR:
                ...
                if (!filePath.isEmpty()) {
                    ...
                    dataIntent.putExtra("PATH", filePath);
    ...
    private void setFromLib() {
        findViewById(R.id.picture_from_lib).setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (os != null) {
                            try {
                                Intent dataIntent = new Intent();
                                dataIntent.putExtra("PATH", file.getAbsolutePath());
                                setResult(RESULT_OK, dataIntent);
                                finish();
                                os.close();
                            } catch (IOException e) {
