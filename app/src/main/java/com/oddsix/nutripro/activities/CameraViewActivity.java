...
@Deprecated
public class CameraViewActivity extends BaseActivity implements
        ...
        switch (requestCode) {
            ...
            case REQUEST_IMAGE_SELECTOR:
                ...
                if (!filePath.isEmpty()) {
                    ...
                    dataIntent.putExtra(Constants.EXTRA_FILE_PATH, filePath);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (os != null) {
                            try {
                                Intent dataIntent = new Intent();
                                dataIntent.putExtra(Constants.EXTRA_FILE_PATH, file.getAbsolutePath());
                                setResult(RESULT_OK, dataIntent);
                                finish();
                                os.close();
                            } catch (IOException e) {
