...
public class FeedbackHelper {
    ...
    private void addLoading() {
        ...
        ((ProgressBar) mLoadingView.findViewById(R.id.default_progressbar)).getIndeterminateDrawable()
                .mutate().setColorFilter(ContextCompat.getColor(mContext, mProgressBarColor == RESOURCE_NOT_DEFINED ? R.color.colorPrimary : mProgressBarColor), PorterDuff.Mode.SRC_ATOP);
